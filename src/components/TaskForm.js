...
export default function TaskForm({tasks,setTasks}) {
   ...
   const handleSubmit = (e)=>{
    ...
    e.preventDefault();
    let updatedTasks = [...tasks,{id:Date.now(),title:formData.title,description:formData.description,done:false}]
    setTasks(updatedTasks);
    console.log(tasks);
    //Set form fields to empty once user has added a task
    setFormData({
        title:'',
        description:''
    })
